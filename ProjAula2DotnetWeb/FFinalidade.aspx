<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FFinalidade.aspx.cs" Inherits="ProjP2.FFinalidade" %>
...
<body>
    <form id="form1" runat="server">
          ...
          <div class="form-group">
                    ...
                    <asp:TextBox ID="TxtOrigem" CssClass="form-control" runat="server" Width="322px"></asp:TextBox>
                </div>
